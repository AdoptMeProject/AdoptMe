...
const users = [
  ...
  { name: 'ANAA Asociación Amigos de los Animales', email: faker.internet.email(), avatar: 'https://pbs.twimg.com/profile_images/1179340461460381697/Ag1K6at5_400x400.jpg', password: '1234', shelter: true, address: 'ANAA Protectora De animales, 28150 Valdetorres de Jarama, Madrid, España', locationTest: 'ANNA+Protectora+de+animales,Madrid+Spain', city: 'Madrid - Fuente el Saz de Jarama', phone: '916 672 036', bio: faker.lorem.paragraph(), activation: { active: true } },
  ...
  { name: 'Pérrikus', email: faker.internet.email(), avatar: 'http://perrikus.org/wp-content/uploads/2016/08/Img_logo2-1.png', password: '1234', shelter: true, address: faker.address.streetAddress(), city: 'Madrid', locationTest: 'perrikus,Madrid+Spain', phone: faker.phone.phoneNumber(), bio: faker.lorem.paragraph(), activation: { active: true } },
  { name: 'Rivanimal', email: faker.internet.email(), avatar: 'https://rivanimal.org/_mibambu/_rivanimal/imas/logo.jpg', password: '1234', shelter: true, address: faker.address.streetAddress(), city: 'Madrid', locationTest: 'Rivanimal,Madrid+Spain', phone: faker.phone.phoneNumber(), bio: faker.lorem.paragraph(), activation: { active: true } },
  ...
  { name: 'Proa', email: 'adopciones@proaweb.org', avatar: 'https://img.miwuki.com/p/9DEG7U/250', password: '1234', shelter: true, address: 'Proa, 28025 Leganés, Madrid', city: 'Madrid - Leganés', locationTest: 'Proa,Madrid+Spain', phone: faker.phone.phoneNumber(), bio: faker.lorem.paragraph(), activation: { active: true } },
]
